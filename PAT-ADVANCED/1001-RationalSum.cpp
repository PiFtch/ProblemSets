...
followed in the next line N rational numbers "a1/b1 a2/b2 ..." where all the numerators and denominators are in the range of "long int".  
...
"numerator" < "denominator", and the numerator and the denominator have no common factor.  
...
int main() {
    int N;
    long sumOfNumerators = 0, sumOfDenominators = 0;
    // Get the input
    while (scanf("%d", &N) == 1) {
